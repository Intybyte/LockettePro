...
import me.crafter.mc.lockettepro.dependency.DependencyProtocolLib;
import me.crafter.mc.lockettepro.listeners.BlockDebugListener;
import me.crafter.mc.lockettepro.listeners.BlockEnvironmentListener;
import me.crafter.mc.lockettepro.listeners.BlockInventoryMoveListener;
import me.crafter.mc.lockettepro.listeners.BlockPlayerListener;
...
public class LockettePro extends JavaPlugin {
    ...
    private void checkMcVersion() {
        ...
        String msg = "Compatible server version detected: " + version;

        if (version.matches("1.20") || version.matches("1.20.1") ) {
    ...
    public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, final String[] args){
        ...
        case "4":
            ...
            if (!LocketteProAPI.isSign(block) || !(player.hasPermission("lockettepro.edit.admin") || LocketteProAPI.isOwnerOfSign(block, player))){
